...
parser.add_argument('--volume_path', type=str,default='data_sets/Synapse/test_vol_h5', help='root dir for validation volume data') 
...
if __name__ == "__main__":
    ...
    dataset_config = {
        'Synapse': {
            ...
            'volume_path': 'data_sets/Synapse/test_vol_h5',
