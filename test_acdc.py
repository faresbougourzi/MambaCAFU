...
from utils.dataset_acdc_seg import ACDCdataset , RandomGenerator
...
parser.add_argument('--volume_path', type=str,default='data_sets/ACDC', help='root dir for validation volume data')  # for acdc volume_path=root_dir
parser.add_argument('--dataset', type=str,default='ACDC', help='experiment_name')
parser.add_argument('--num_classes', type=int,default=4, help='output channel of network')
parser.add_argument('--list_dir', type=str,default='data_sets/ACDC/lists_ACDC', help='list dir')
...
if __name__ == "__main__":
    ...
    for epoch_num in list_epoch_num:
        ...
        snapshot = os.path.join(snapshot_path, weight_name) 
